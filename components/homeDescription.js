...
const HomeDescription = () => {
    return (
        <div>
            ...
            <br/>
            <h3>De l’ameublement à la décoration, notre catalogue répond à toutes vos envies :</h3>
            ...
            <br/>
            <h4>Avec Decofinder tout est possible :</h4>
            ...
            <br/>
            <h3>Un espace dédié pour les créateurs et les exposants :</h3>
            ...
            <br/>
            <h3>Decofinder c'est aussi des idées et des conseils tendances pour votre intérieur et votre extérieur en matière de décoration et d’ameublement :</h3>
